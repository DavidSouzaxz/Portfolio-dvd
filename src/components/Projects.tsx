  ...
  const projects = [
    {
      ...
      github: "https://github.com/DavidSouzaxz/e-commerce",
      demo: "https://github.com/DavidSouzaxz/e-commerce/blob/main/README.md",
    },
    {
      title: "To-do List",
    ...
    },
    {
      ...
      description: "Ferramenta de análise de redes sociais com métricas avançadas e relatórios personalizados.",
    ...
    },
    {
      ...
      image: "https://images.ctfassets.net/rvt0uslu5yqp/4zVG1eCQtjAIsLCl2mNa2e/e58a8586b81347a387db31417bc86020/Blog_Quiz_Cover-01.png?w=540&q=60",
    ...
    {
      title: "API REST",
      description: "A API permite realizar operações CRUD para gerenciar recursos de forma eficiente.",
      image: "https://document360.com/wp-content/uploads/2022/11/rest_api_examples_and_challenges-1200x683.jpg",
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Uma seleção dos meus trabalhos mais recentes, demonstrando diferentes tecnologias e abordagens de
              desenvolvimento.
            </p>
          </div>
